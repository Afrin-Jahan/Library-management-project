 ...
 * @author DELL
 */
public class siBooks extends javax.swing.JFrame {

    /**
     * Creates new form siBooks
     */
    public siBooks() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(rs.next())
            {
                ...
                if(rs1.next())
                {
                    ResultSet rs2 = st.executeQuery("select *from issuest where ID_number='"+ID_number+"'and Return_book='No'");
                    if(!rs2.next())
                    {
                        st.executeUpdate("insert into issuest values('" + Book_ID + "','" + ID_number + "','" + Issue_date + "','" + Due_date + "','" + Return_book + "')");
                        JOptionPane.showConfirmDialog(null, "Book successfully issued");
                        setVisible(false);
                        new siBooks().setVisible(true);
                    }
                    else
                    {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(siBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
